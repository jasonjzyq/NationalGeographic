...
<body>
	<div id="div1"></div>
	<form action="submitArt" method="post" name="form">
		标题：<input type="text" name="articleTitle">
		导语：<input type="text" name="articleLead">
		日期：<input type="date" name="articleDate">
		<input type="text" name="articleContent">
	</form>
	<button id="btn1">提交进入审核</button>
</body>
</html>